...
function Chat() {
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden">
      {messages.length === 0 ? (
        <div className="flex flex-1 items-center justify-center px-3 md:px-5">
          <div className="flex flex-col items-center justify-center w-full max-w-3xl">
            <PromptInput
              ...
              className="border-input bg-sidebar relative z-10 w-full border p-0 pt-1 shadow-xs"
            >
        ...
        <>
          ...
          <div className="inset-x-0 bottom-0 mx-auto w-full max-w-3xl shrink-0 px-3 pb-3 md:px-5 md:pb-5">
            <PromptInput
              ...
              onValueChange={setInput}
              onSubmit={handleSubmit}
              className="border-input bg-background relative z-10 w-full border p-0 pt-1 shadow-xs"
            >
              <div className="flex flex-col">
                <PromptInputTextarea
                  placeholder="Ask anything"
