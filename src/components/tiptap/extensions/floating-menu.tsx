...
export function TipTapFloatingMenu({ editor }: { editor: Editor }) {
  ...
  useEffect(() => {
    ...
    setSelectedIndex(flatFilteredItems.length > 0 ? 0 : -1)
  }, [isOpen, flatFilteredItems])
