...
const TreeActions = ({
  ...
  // Keep the actions in the DOM at all times to maintain a stable anchor
  // for portalled overlays (e.g., dropdown menus). Toggle visibility instead
  // of display so the trigger isn't unmounted when the cursor leaves the row.
  return (
    <div
      className={cn(
