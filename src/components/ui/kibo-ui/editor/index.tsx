...
export const EditorFloatingMenu = ({
  ...
  useEffect(() => {
    ...
    const key = pluginKey ?? new PluginKey('floatingMenu')
  ...
  }, [editor, pluginKey, shouldShow, options])

  return (
    <div className={cn('flex items-center bg-secondary', className)} ref={containerRef}>
      {children}
    </div>
  )
}
...
export const EditorBubbleMenu = ({
  ...
  useEffect(() => {
    ...
    const key = pluginKey ?? new PluginKey('bubbleMenu')
